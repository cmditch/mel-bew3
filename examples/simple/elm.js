...
var _cmditch$mel_bew3$Web3_Internal_Types$Address = function (a) {
	return {ctor: 'Address', _0: a};
};
var _cmditch$mel_bew3$Web3_Internal_Types$TxHash = function (a) {
	return {ctor: 'TxHash', _0: a};
};
var _cmditch$mel_bew3$Web3_Internal_Types$BlockHash = function (a) {
	return {ctor: 'BlockHash', _0: a};
};
var _cmditch$mel_bew3$Web3_Internal_Types$WhisperId = function (a) {
	return {ctor: 'WhisperId', _0: a};
};
var _cmditch$mel_bew3$Web3_Internal_Types$IPFSHash = function (a) {
	return {ctor: 'IPFSHash', _0: a};
};
var _cmditch$mel_bew3$Web3_Internal_Types$Hex = function (a) {
	return {ctor: 'Hex', _0: a};
};

var _cmditch$mel_bew3$Web3_Internal_Utils$toByteLength = function (s) {
	return _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$String$length(s),
		1) ? A2(_elm_lang$core$String$append, '0', s) : s;
};
var _cmditch$mel_bew3$Web3_Internal_Utils$listOfMaybesToVal = function (keyValueList) {
		...
		A2(
			...
			function (_p0) {
				...
				return {
					ctor: '_Tuple2',
					_0: _p1._0,
					_1: A2(_elm_lang$core$Maybe$withDefault, _elm_lang$core$Json_Encode$null, _p1._1)
				};
			},
			A2(
				_elm_lang$core$List$filter,
...
var _cmditch$mel_bew3$Web3_Internal_Utils$quote = function (str) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'\"',
...
var _cmditch$mel_bew3$Web3_Eth_Types$Call = F8(
	function (a, b, c, d, e, f, g, h) {
		return {to: a, from: b, gas: c, gasPrice: d, value: e, data: f, nonce: g, decoder: h};
	});
var _cmditch$mel_bew3$Web3_Eth_Types$Send = F7(
	function (a, b, c, d, e, f, g) {
		return {to: a, from: b, gas: c, gasPrice: d, value: e, data: f, nonce: g};
	});
var _cmditch$mel_bew3$Web3_Eth_Types$Tx = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _cmditch$mel_bew3$Web3_Eth_Types$TxReceipt = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _cmditch$mel_bew3$Web3_Eth_Types$Block = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _cmditch$mel_bew3$Web3_Eth_Types$BlockHead = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _cmditch$mel_bew3$Web3_Eth_Types$Log = F9(
...
var _cmditch$mel_bew3$Web3_Eth_Types$Event = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _cmditch$mel_bew3$Web3_Eth_Types$LogFilter = F4(
	function (a, b, c, d) {
		return {fromBlock: a, toBlock: b, address: c, topics: d};
	});
var _cmditch$mel_bew3$Web3_Eth_Types$SyncStatus = F5(
	function (a, b, c, d, e) {
		return {startingBlock: a, currentBlock: b, highestBlock: c, knownStates: d, pulledStates: e};
	});
var _cmditch$mel_bew3$Web3_Eth_Types$PendingBlock = {ctor: 'PendingBlock'};
var _cmditch$mel_bew3$Web3_Eth_Types$LatestBlock = {ctor: 'LatestBlock'};
var _cmditch$mel_bew3$Web3_Eth_Types$EarliestBlock = {ctor: 'EarliestBlock'};
var _cmditch$mel_bew3$Web3_Eth_Types$BlockIdHash = function (a) {
	return {ctor: 'BlockIdHash', _0: a};
};
var _cmditch$mel_bew3$Web3_Eth_Types$BlockIdNum = function (a) {
	return {ctor: 'BlockIdNum', _0: a};
};

var _cmditch$mel_bew3$Web3_Utils$compareCharToHash = F2(
...
var _cmditch$mel_bew3$Web3_Utils$makeIPFSHash = function (str) {
	return (!_elm_lang$core$Native_Utils.eq(
		...
		function (_p0) {
			return _elm_lang$core$Result$Ok(
				_cmditch$mel_bew3$Web3_Internal_Types$IPFSHash(str));
		},
		_nathanjohnson320$base58$Base58$decode(str)));
};
var _cmditch$mel_bew3$Web3_Utils$ipfsToBytes32 = function (_p1) {
	var _p2 = _p1;
	return A2(
		_elm_lang$core$Result$withDefault,
		'this should never happen, document what you did to get this outcome',
		A2(
			_elm_lang$core$Result$map,
			function (_p3) {
				return A2(
					_elm_lang$core$String$dropLeft,
					4,
					_hickscorp$elm_bigint$BigInt$toHexString(_p3));
			},
			_nathanjohnson320$base58$Base58$decode(_p2._0)));
};
var _cmditch$mel_bew3$Web3_Utils$ipfsHashToString = function (_p4) {
	var _p5 = _p4;
	return _p5._0;
};
var _cmditch$mel_bew3$Web3_Utils$isSha256 = _elm_lang$core$Regex$contains(
	_elm_lang$core$Regex$regex('^((0[Xx]){1})?[0-9a-fA-F]{64}$'));
var _cmditch$mel_bew3$Web3_Utils$keccak256 = function (str) {
	return A2(
		F2(
			function (x, y) {
		...
		A2(
			...
			A2(
				_elm_lang$core$List$map,
				function (_p6) {
					return _cmditch$mel_bew3$Web3_Internal_Utils$toByteLength(
						_rtfeldman$hex$Hex$toString(_p6));
				},
...
var _cmditch$mel_bew3$Web3_Utils$functionSig = function (fSig) {
	return A2(
		F2(
			function (x, y) {
				return A2(_elm_lang$core$Basics_ops['++'], x, y);
		...
		A2(
			...
			A2(
				...
				function (_p7) {
					return _cmditch$mel_bew3$Web3_Internal_Utils$toByteLength(
						_rtfeldman$hex$Hex$toString(_p7));
				},
				A2(
					_elm_lang$core$List$take,
					4,
...
var _cmditch$mel_bew3$Web3_Utils$remove0x = function (str) {
...
var _cmditch$mel_bew3$Web3_Utils$toTxHash = function (str) {
	return _cmditch$mel_bew3$Web3_Utils$isSha256(str) ? _elm_lang$core$Result$Ok(
		_cmditch$mel_bew3$Web3_Internal_Types$TxHash(
			_cmditch$mel_bew3$Web3_Utils$remove0x(str))) : _elm_lang$core$Result$Err(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'Given txHash ',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_cmditch$mel_bew3$Web3_Internal_Utils$quote(str),
				' is not valid.')));
};
var _cmditch$mel_bew3$Web3_Utils$toBlockHash = function (str) {
	return _cmditch$mel_bew3$Web3_Utils$isSha256(str) ? _elm_lang$core$Result$Ok(
		_cmditch$mel_bew3$Web3_Internal_Types$BlockHash(
			_cmditch$mel_bew3$Web3_Utils$remove0x(str))) : _elm_lang$core$Result$Err(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'Given blockHash ',
...
var _cmditch$mel_bew3$Web3_Utils$unsafeToHex = function (_p8) {
	return _cmditch$mel_bew3$Web3_Internal_Types$Hex(
		_cmditch$mel_bew3$Web3_Utils$remove0x(_p8));
};
var _cmditch$mel_bew3$Web3_Utils$unsafeToAddress = function (_p9) {
	return _cmditch$mel_bew3$Web3_Internal_Types$Address(
		_cmditch$mel_bew3$Web3_Utils$remove0x(_p9));
};
var _cmditch$mel_bew3$Web3_Utils$unsafeToTxHash = function (_p10) {
	return _cmditch$mel_bew3$Web3_Internal_Types$TxHash(
		_cmditch$mel_bew3$Web3_Utils$remove0x(_p10));
};
var _cmditch$mel_bew3$Web3_Utils$unsafeToBlockHash = function (_p11) {
	return _cmditch$mel_bew3$Web3_Internal_Types$BlockHash(
		_cmditch$mel_bew3$Web3_Utils$remove0x(_p11));
};
var _cmditch$mel_bew3$Web3_Utils$checksumHelper = function (address) {
	var addressChars = _elm_lang$core$String$toList(
		_cmditch$mel_bew3$Web3_Utils$remove0x(address));
	return A2(
		F2(
			function (v0, v1) {
				return {ctor: '_Tuple2', _0: v0, _1: v1};
					...
					A2(
						...
						A2(
							...
							A2(
								...
								function (_p12) {
									return _cmditch$mel_bew3$Web3_Internal_Utils$toByteLength(
										_rtfeldman$hex$Hex$toString(_p12));
								},
								A2(
									_elm_lang$core$List$take,
									20,
										...
										A2(
											...
											function (_p13) {
												return _elm_lang$core$Char$toCode(
													_elm_lang$core$Char$toLower(_p13));
											},
											addressChars))))))))));
};
var _cmditch$mel_bew3$Web3_Utils$checksumIt = function (str) {
	return _elm_lang$core$String$fromList(
		A2(
			_elm_lang$core$Basics$uncurry,
			_elm_lang$core$List$map2(_cmditch$mel_bew3$Web3_Utils$compareCharToHash),
			_cmditch$mel_bew3$Web3_Utils$checksumHelper(str)));
};
var _cmditch$mel_bew3$Web3_Utils$add0x = function (str) {
...
var _cmditch$mel_bew3$Web3_Utils$txHashToString = function (_p14) {
	var _p15 = _p14;
	return _cmditch$mel_bew3$Web3_Utils$add0x(_p15._0);
};
var _cmditch$mel_bew3$Web3_Utils$blockHashToString = function (_p16) {
	var _p17 = _p16;
	return _cmditch$mel_bew3$Web3_Utils$add0x(_p17._0);
};
var _cmditch$mel_bew3$Web3_Utils$hexToAscii = function (str) {
	...
	if (_p18 === true) {
		return A2(
			...
			function (_p19) {
				return _elm_lang$core$String$fromList(
					A2(_elm_lang$core$List$map, _elm_lang$core$Char$fromCode, _p19));
			},
			_elm_community$result_extra$Result_Extra$combine(
				A2(
					_elm_lang$core$List$map,
					_rtfeldman$hex$Hex$fromString,
					A2(
						_elm_community$string_extra$String_Extra$break,
						2,
						_cmditch$mel_bew3$Web3_Utils$remove0x(str)))));
	} else {
		return _elm_lang$core$Result$Err(
			A2(
				_elm_lang$core$Basics_ops['++'],
...
var _cmditch$mel_bew3$Web3_Utils$isHex = _elm_lang$core$Regex$contains(
	_elm_lang$core$Regex$regex('^((0[Xx]){1})?[0-9a-fA-F]+$'));
var _cmditch$mel_bew3$Web3_Utils$hexToString = function (_p20) {
	var _p21 = _p20;
	return _cmditch$mel_bew3$Web3_Utils$add0x(_p21._0);
};
var _cmditch$mel_bew3$Web3_Utils$toHex = function (str) {
	return _cmditch$mel_bew3$Web3_Utils$isHex(str) ? _elm_lang$core$Result$Ok(
		_cmditch$mel_bew3$Web3_Internal_Types$Hex(
			_cmditch$mel_bew3$Web3_Utils$remove0x(str))) : _elm_lang$core$Result$Err(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'Given hex ',
...
var _cmditch$mel_bew3$Web3_Utils$isUpperCaseAddress = _elm_lang$core$Regex$contains(
	_elm_lang$core$Regex$regex('^((0[Xx]){1})?[0-9A-F]{40}$'));
var _cmditch$mel_bew3$Web3_Utils$isLowerCaseAddress = _elm_lang$core$Regex$contains(
	_elm_lang$core$Regex$regex('^((0[Xx]){1})?[0-9a-f]{40}$'));
var _cmditch$mel_bew3$Web3_Utils$isAddress = _elm_lang$core$Regex$contains(
	_elm_lang$core$Regex$regex('^((0[Xx]){1})?[0-9A-Fa-f]{40}$'));
var _cmditch$mel_bew3$Web3_Utils$isChecksumAddress = function (str) {
	...
	var checksumCorrect = A2(
		...
		_cmditch$mel_bew3$Web3_Utils$checksumHelper(str));
	return _cmditch$mel_bew3$Web3_Utils$isAddress(str) ? _Chadtech$elm_bool_extra$Bool_Extra$all(checksumCorrect) : false;
};
var _cmditch$mel_bew3$Web3_Utils$addressToString = function (_p22) {
	var _p23 = _p22;
	return _cmditch$mel_bew3$Web3_Utils$add0x(
		_cmditch$mel_bew3$Web3_Utils$checksumIt(
			_elm_lang$core$String$toLower(_p23._0)));
};
var _cmditch$mel_bew3$Web3_Utils$toChecksumAddress = function (str) {
	return _cmditch$mel_bew3$Web3_Utils$isAddress(str) ? _elm_lang$core$Result$Ok(
		_cmditch$mel_bew3$Web3_Internal_Types$Address(
			_cmditch$mel_bew3$Web3_Utils$checksumIt(str))) : _elm_lang$core$Result$Err(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'Given address ',
			A2(
...
var _cmditch$mel_bew3$Web3_Utils$toAddress = function (str) {
	var bytes32Address = A2(_elm_lang$core$String$right, 40, str);
	var noZeroX = _cmditch$mel_bew3$Web3_Utils$remove0x(str);
	return (_elm_lang$core$Native_Utils.eq(
		...
		F2(
			...
			_elm_lang$core$Native_Utils.chr('0')),
		A2(_elm_lang$core$String$left, 24, noZeroX))) ? ((_cmditch$mel_bew3$Web3_Utils$isUpperCaseAddress(bytes32Address) || _cmditch$mel_bew3$Web3_Utils$isLowerCaseAddress(bytes32Address)) ? _elm_lang$core$Result$Ok(
		_cmditch$mel_bew3$Web3_Internal_Types$Address(
			_elm_lang$core$String$toLower(bytes32Address))) : (_cmditch$mel_bew3$Web3_Utils$isChecksumAddress(bytes32Address) ? _elm_lang$core$Result$Ok(
		_cmditch$mel_bew3$Web3_Internal_Types$Address(bytes32Address)) : _elm_lang$core$Result$Err(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'Given address ',
			A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_cmditch$mel_bew3$Web3_Internal_Utils$quote(str),
				' is too long'))) : ((!_cmditch$mel_bew3$Web3_Utils$isAddress(noZeroX)) ? _elm_lang$core$Result$Err(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'Given address ',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_cmditch$mel_bew3$Web3_Internal_Utils$quote(str),
				' contains invalid hex characters.'))) : ((_cmditch$mel_bew3$Web3_Utils$isUpperCaseAddress(noZeroX) || _cmditch$mel_bew3$Web3_Utils$isLowerCaseAddress(noZeroX)) ? _elm_lang$core$Result$Ok(
		_cmditch$mel_bew3$Web3_Internal_Types$Address(
			_elm_lang$core$String$toLower(str))) : (_cmditch$mel_bew3$Web3_Utils$isChecksumAddress(noZeroX) ? _elm_lang$core$Result$Ok(
		_cmditch$mel_bew3$Web3_Internal_Types$Address(noZeroX)) : _elm_lang$core$Result$Err(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'Given address ',
			A2(
...
var _cmditch$mel_bew3$Web3_Utils$valToMsg = F3(
	function (successMsg, failureMsg, decoder) {
		var resultToMessage = function (result) {
			var _p24 = result;
			if (_p24.ctor === 'Ok') {
				return successMsg(_p24._0);
			} else {
				return failureMsg(_p24._0);
			}
		};
		return function (_p25) {
			return resultToMessage(
				A2(_elm_lang$core$Json_Decode$decodeValue, decoder, _p25));
		};
	});
var _cmditch$mel_bew3$Web3_Utils$eth = function () {
	var oneEth = A2(
		_hickscorp$elm_bigint$BigInt$mul,
	...
	return function (_p26) {
		return A2(
			_hickscorp$elm_bigint$BigInt$mul,
			oneEth,
			_hickscorp$elm_bigint$BigInt$fromInt(_p26));
	};
}();
var _cmditch$mel_bew3$Web3_Utils$gwei = function (_p27) {
	return A2(
		_hickscorp$elm_bigint$BigInt$mul,
		_hickscorp$elm_bigint$BigInt$fromInt(1000000000),
		_hickscorp$elm_bigint$BigInt$fromInt(_p27));
};
var _cmditch$mel_bew3$Web3_Utils$Retry = F2(
	function (a, b) {
		return {attempts: a, sleep: b};
	});
var _cmditch$mel_bew3$Web3_Utils$retry = F2(
	function (_p28, myTask) {
		var _p29 = _p28;
		var _p31 = _p29.sleep;
		var remaining = _p29.attempts - 1;
		return A2(
			_elm_lang$core$Task$onError,
			function (x) {
				return (_elm_lang$core$Native_Utils.cmp(remaining, 0) > 0) ? A2(
					...
					function (_p30) {
						return A2(
							_cmditch$mel_bew3$Web3_Utils$retry,
							A2(_cmditch$mel_bew3$Web3_Utils$Retry, remaining, _p31),
							myTask);
					},
					_elm_lang$core$Process$sleep(_p31 * _elm_lang$core$Time$second)) : _elm_lang$core$Task$fail(x);
			},
			myTask);
	});

var _cmditch$mel_bew3$Web3_Decode$nonZero = function (decoder) {
	var checkZero = function (str) {
		return (_elm_lang$core$Native_Utils.eq(str, '0x') || _elm_lang$core$Native_Utils.eq(str, '0x0')) ? _elm_lang$core$Json_Decode$succeed(_elm_lang$core$Maybe$Nothing) : (A2(
			...
			_cmditch$mel_bew3$Web3_Utils$remove0x(str)) ? _elm_lang$core$Json_Decode$succeed(_elm_lang$core$Maybe$Nothing) : A2(_elm_lang$core$Json_Decode$map, _elm_lang$core$Maybe$Just, decoder));
	};
	return A2(_elm_lang$core$Json_Decode$andThen, checkZero, _elm_lang$core$Json_Decode$string);
};
var _cmditch$mel_bew3$Web3_Decode$resultToDecoder = function (strToResult) {
...
var _cmditch$mel_bew3$Web3_Decode$hexBool = function () {
	...
	return _cmditch$mel_bew3$Web3_Decode$resultToDecoder(isBool);
}();
var _cmditch$mel_bew3$Web3_Decode$hexTime = _cmditch$mel_bew3$Web3_Decode$resultToDecoder(
	function (_p2) {
		return A2(
			_elm_lang$core$Result$map,
			_elm_lang$core$Basics$toFloat,
			_rtfeldman$hex$Hex$fromString(
				_cmditch$mel_bew3$Web3_Utils$remove0x(_p2)));
	});
var _cmditch$mel_bew3$Web3_Decode$bigInt = _cmditch$mel_bew3$Web3_Decode$resultToDecoder(
	function (_p3) {
		return A2(
			_elm_lang$core$Result$fromMaybe,
			'Error decoding hex to BigInt',
			_hickscorp$elm_bigint$BigInt$fromString(_p3));
	});
var _cmditch$mel_bew3$Web3_Decode$hexInt = _cmditch$mel_bew3$Web3_Decode$resultToDecoder(
	function (_p4) {
		return _rtfeldman$hex$Hex$fromString(
			_cmditch$mel_bew3$Web3_Utils$remove0x(_p4));
	});
var _cmditch$mel_bew3$Web3_Decode$stringInt = _cmditch$mel_bew3$Web3_Decode$resultToDecoder(_elm_lang$core$String$toInt);

var _cmditch$mel_bew3$Web3_Eth_Decode$syncStatus = _elm_lang$core$Json_Decode$maybe(
	A3(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'startingBlock',
						_elm_lang$core$Json_Decode$int,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_cmditch$mel_bew3$Web3_Eth_Types$SyncStatus)))))));
var _cmditch$mel_bew3$Web3_Eth_Decode$hex = _cmditch$mel_bew3$Web3_Decode$resultToDecoder(_cmditch$mel_bew3$Web3_Utils$toHex);
var _cmditch$mel_bew3$Web3_Eth_Decode$blockHash = _cmditch$mel_bew3$Web3_Decode$resultToDecoder(_cmditch$mel_bew3$Web3_Utils$toBlockHash);
var _cmditch$mel_bew3$Web3_Eth_Decode$txHash = _cmditch$mel_bew3$Web3_Decode$resultToDecoder(_cmditch$mel_bew3$Web3_Utils$toTxHash);
var _cmditch$mel_bew3$Web3_Eth_Decode$address = _cmditch$mel_bew3$Web3_Decode$resultToDecoder(_cmditch$mel_bew3$Web3_Utils$toAddress);
var _cmditch$mel_bew3$Web3_Eth_Decode$block = function (txsDecoder) {
	return A4(
		...
		A4(
			...
			A4(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
				'timestamp',
				_cmditch$mel_bew3$Web3_Decode$hexTime,
				0,
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'gasUsed',
					_cmditch$mel_bew3$Web3_Decode$hexInt,
					A3(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
						'gasLimit',
						_cmditch$mel_bew3$Web3_Decode$hexInt,
						A3(
							...
							A3(
								...
								A4(
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
									'totalDifficulty',
									_cmditch$mel_bew3$Web3_Decode$bigInt,
									_hickscorp$elm_bigint$BigInt$fromInt(0),
									A3(
										_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
										'difficulty',
										...
										A3(
											_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
											'miner',
											_cmditch$mel_bew3$Web3_Eth_Decode$address,
											A3(
												_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
												'receiptsRoot',
												_elm_lang$core$Json_Decode$string,
															...
															A3(
																...
																A3(
																	...
																	A3(
																		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
																		'parentHash',
																		_cmditch$mel_bew3$Web3_Eth_Decode$blockHash,
																		A3(
																			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
																			'hash',
																			_cmditch$mel_bew3$Web3_Eth_Decode$blockHash,
																			A3(
																				...
																				'number',
																				_cmditch$mel_bew3$Web3_Decode$hexInt,
																				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_cmditch$mel_bew3$Web3_Eth_Types$Block))))))))))))))))))));
};
var _cmditch$mel_bew3$Web3_Eth_Decode$uncle = _cmditch$mel_bew3$Web3_Eth_Decode$block(
	_elm_lang$core$Json_Decode$succeed(
		{ctor: '_Tuple0'}));
var _cmditch$mel_bew3$Web3_Eth_Decode$blockHead = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'timestamp',
	_cmditch$mel_bew3$Web3_Decode$hexTime,
	A3(
													...
													A3(
														...
														A3(
															...
															A3(
																...
																'number',
																_cmditch$mel_bew3$Web3_Decode$hexInt,
																_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_cmditch$mel_bew3$Web3_Eth_Types$BlockHead)))))))))))))))));
var _cmditch$mel_bew3$Web3_Eth_Decode$tx = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'input',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			A3(
				...
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'to',
					_elm_lang$core$Json_Decode$nullable(_cmditch$mel_bew3$Web3_Eth_Decode$address),
					A3(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
						'from',
						_cmditch$mel_bew3$Web3_Eth_Decode$address,
						A3(
							...
							A3(
								_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
								'blockNumber',
								_elm_lang$core$Json_Decode$nullable(_cmditch$mel_bew3$Web3_Decode$hexInt),
								A3(
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
									'blockHash',
									_cmditch$mel_bew3$Web3_Decode$nonZero(_cmditch$mel_bew3$Web3_Eth_Decode$blockHash),
									A3(
										_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
										'nonce',
										_cmditch$mel_bew3$Web3_Decode$hexInt,
										A3(
											_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
											'hash',
											_cmditch$mel_bew3$Web3_Eth_Decode$txHash,
											_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_cmditch$mel_bew3$Web3_Eth_Types$Tx))))))))))));
var _cmditch$mel_bew3$Web3_Eth_Decode$log = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'blockNumber',
	_cmditch$mel_bew3$Web3_Decode$hexInt,
	A3(
						...
						A3(
							...
							A3(
								...
								A3(
									...
									'address',
									_cmditch$mel_bew3$Web3_Eth_Decode$address,
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_cmditch$mel_bew3$Web3_Eth_Types$Log))))))))));
var _cmditch$mel_bew3$Web3_Eth_Decode$txReceipt = A2(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$field, 'status', _cmditch$mel_bew3$Web3_Decode$hexBool)),
	A2(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
		_elm_lang$core$Json_Decode$maybe(
		...
		A3(
			...
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'logs',
				_elm_lang$core$Json_Decode$list(_cmditch$mel_bew3$Web3_Eth_Decode$log),
				A2(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
					_elm_lang$core$Json_Decode$maybe(
						A2(_elm_lang$core$Json_Decode$field, 'contractAddress', _cmditch$mel_bew3$Web3_Eth_Decode$address)),
					A3(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
						'cumulativeGasUsed',
						_cmditch$mel_bew3$Web3_Decode$bigInt,
								...
								A3(
									...
									A3(
										...
										A3(
											...
											'transactionHash',
											_cmditch$mel_bew3$Web3_Eth_Decode$txHash,
											_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_cmditch$mel_bew3$Web3_Eth_Types$TxReceipt))))))))))));
var _cmditch$mel_bew3$Web3_Eth_Decode$event = function (returnDataDecoder) {
	return A2(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
		returnDataDecoder,
		A3(
								...
								A3(
									...
									A3(
										...
										A3(
											...
											'address',
											_cmditch$mel_bew3$Web3_Eth_Decode$address,
											_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_cmditch$mel_bew3$Web3_Eth_Types$Event)))))))))));
};

var _cmditch$mel_bew3$Web3_Encode$hexInt = function (_p0) {
	return _elm_lang$core$Json_Encode$string(
		_cmditch$mel_bew3$Web3_Utils$add0x(
			_rtfeldman$hex$Hex$toString(_p0)));
};
var _cmditch$mel_bew3$Web3_Encode$hex = function (_p1) {
	return _elm_lang$core$Json_Encode$string(
		_cmditch$mel_bew3$Web3_Utils$hexToString(_p1));
};
var _cmditch$mel_bew3$Web3_Encode$bigInt = function (_p2) {
	return _elm_lang$core$Json_Encode$string(
		_cmditch$mel_bew3$Web3_Utils$add0x(
			_hickscorp$elm_bigint$BigInt$toHexString(_p2)));
};

var _cmditch$mel_bew3$Web3_Eth_Encode$topicsList = function (topicsList) {
...
var _cmditch$mel_bew3$Web3_Eth_Encode$blockHash = function (_p1) {
	return _elm_lang$core$Json_Encode$string(
		_cmditch$mel_bew3$Web3_Utils$blockHashToString(_p1));
};
var _cmditch$mel_bew3$Web3_Eth_Encode$blockId = function (blockId) {
	var _p2 = blockId;
	switch (_p2.ctor) {
		case 'BlockIdNum':
			return _elm_lang$core$Json_Encode$string(
				_cmditch$mel_bew3$Web3_Utils$add0x(
					_rtfeldman$hex$Hex$toString(_p2._0)));
		case 'BlockIdHash':
			return _cmditch$mel_bew3$Web3_Eth_Encode$blockHash(_p2._0);
		case 'EarliestBlock':
...
var _cmditch$mel_bew3$Web3_Eth_Encode$txHash = function (_p3) {
	return _elm_lang$core$Json_Encode$string(
		_cmditch$mel_bew3$Web3_Utils$txHashToString(_p3));
};
var _cmditch$mel_bew3$Web3_Eth_Encode$address = function (_p4) {
	return _elm_lang$core$Json_Encode$string(
		_cmditch$mel_bew3$Web3_Utils$addressToString(_p4));
};
var _cmditch$mel_bew3$Web3_Eth_Encode$callParams = function (_p5) {
	var _p6 = _p5;
	return _cmditch$mel_bew3$Web3_Internal_Utils$listOfMaybesToVal(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'to',
				_1: A2(_elm_lang$core$Maybe$map, _cmditch$mel_bew3$Web3_Eth_Encode$address, _p6.to)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'from',
					_1: A2(_elm_lang$core$Maybe$map, _cmditch$mel_bew3$Web3_Eth_Encode$address, _p6.from)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'gas',
						_1: A2(_elm_lang$core$Maybe$map, _cmditch$mel_bew3$Web3_Encode$hexInt, _p6.gas)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'gasPrice',
							_1: A2(_elm_lang$core$Maybe$map, _cmditch$mel_bew3$Web3_Encode$bigInt, _p6.gasPrice)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'value',
								_1: A2(_elm_lang$core$Maybe$map, _cmditch$mel_bew3$Web3_Encode$bigInt, _p6.value)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'data',
									_1: A2(_elm_lang$core$Maybe$map, _cmditch$mel_bew3$Web3_Encode$hex, _p6.data)
								},
								_1: {ctor: '[]'}
							}
						}
...
var _cmditch$mel_bew3$Web3_Eth_Encode$sendParams = function (_p7) {
	var _p8 = _p7;
	return _cmditch$mel_bew3$Web3_Internal_Utils$listOfMaybesToVal(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'to',
				_1: A2(_elm_lang$core$Maybe$map, _cmditch$mel_bew3$Web3_Eth_Encode$address, _p8.to)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'from',
					_1: A2(_elm_lang$core$Maybe$map, _cmditch$mel_bew3$Web3_Eth_Encode$address, _p8.from)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'gas',
						_1: A2(_elm_lang$core$Maybe$map, _cmditch$mel_bew3$Web3_Encode$hexInt, _p8.gas)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'gasPrice',
							_1: A2(_elm_lang$core$Maybe$map, _cmditch$mel_bew3$Web3_Encode$bigInt, _p8.gasPrice)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'value',
								_1: A2(_elm_lang$core$Maybe$map, _cmditch$mel_bew3$Web3_Encode$bigInt, _p8.value)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'data',
									_1: A2(_elm_lang$core$Maybe$map, _cmditch$mel_bew3$Web3_Encode$hex, _p8.data)
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'nonce',
										_1: A2(_elm_lang$core$Maybe$map, _cmditch$mel_bew3$Web3_Encode$hexInt, _p8.nonce)
									},
									_1: {ctor: '[]'}
								}
							}
...
var _cmditch$mel_bew3$Web3_Eth_Encode$logFilter = function (logFilter) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'fromBlock',
				_1: _cmditch$mel_bew3$Web3_Eth_Encode$blockId(logFilter.fromBlock)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'toBlock',
					_1: _cmditch$mel_bew3$Web3_Eth_Encode$blockId(logFilter.toBlock)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'address',
						_1: _cmditch$mel_bew3$Web3_Eth_Encode$address(logFilter.address)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'topics',
							_1: _cmditch$mel_bew3$Web3_Eth_Encode$topicsList(logFilter.topics)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _cmditch$mel_bew3$Web3_Eth_Encode$addressList = function (_p9) {
	return _elm_lang$core$Json_Encode$list(
		A2(_elm_lang$core$List$map, _cmditch$mel_bew3$Web3_Eth_Encode$address, _p9));
};
...
var _cmditch$mel_bew3$Web3_JsonRPC$encode = F3(
...
var _cmditch$mel_bew3$Web3_JsonRPC$rpcBody = F3(
	function (id, method, params) {
		return _elm_lang$http$Http$jsonBody(
			A3(_cmditch$mel_bew3$Web3_JsonRPC$encode, id, method, params));
	});
var _cmditch$mel_bew3$Web3_JsonRPC$defaultRPCBody = _cmditch$mel_bew3$Web3_JsonRPC$rpcBody(1);
var _cmditch$mel_bew3$Web3_JsonRPC$buildRequest = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$http$Http$toTask(
		A3(
			_elm_lang$http$Http$post,
			_p1.url,
			A2(_cmditch$mel_bew3$Web3_JsonRPC$defaultRPCBody, _p1.method, _p1.params),
			A2(_elm_lang$core$Json_Decode$field, 'result', _p1.decoder)));
};
var _cmditch$mel_bew3$Web3_JsonRPC$RpcRequest = F4(
	function (a, b, c, d) {
		return {url: a, method: b, params: c, decoder: d};
	});

var _cmditch$mel_bew3$Web3_Eth$accounts = function (ethNode) {
	return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
		{
			url: ethNode,
			method: 'eth_accounts',
			params: {ctor: '[]'},
			decoder: _elm_lang$core$Json_Decode$list(_cmditch$mel_bew3$Web3_Eth_Decode$address)
		});
};
var _cmditch$mel_bew3$Web3_Eth$gasPrice = function (ethNode) {
	return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
		{
			url: ethNode,
			method: 'eth_gasPrice',
			params: {ctor: '[]'},
			decoder: _cmditch$mel_bew3$Web3_Decode$bigInt
		});
};
var _cmditch$mel_bew3$Web3_Eth$hashrate = function (ethNode) {
	return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
		{
			url: ethNode,
			method: 'eth_hashrate',
			params: {ctor: '[]'},
			decoder: _cmditch$mel_bew3$Web3_Decode$hexInt
		});
};
var _cmditch$mel_bew3$Web3_Eth$mining = function (ethNode) {
	return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
		{
			url: ethNode,
			method: 'eth_mining',
...
var _cmditch$mel_bew3$Web3_Eth$coinbase = function (ethNode) {
	return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
		{
			url: ethNode,
			method: 'eth_coinbase',
			params: {ctor: '[]'},
			decoder: _cmditch$mel_bew3$Web3_Eth_Decode$address
		});
};
var _cmditch$mel_bew3$Web3_Eth$syncing = function (ethNode) {
	return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
		{
			url: ethNode,
			method: 'eth_syncing',
			params: {ctor: '[]'},
			decoder: _cmditch$mel_bew3$Web3_Eth_Decode$syncStatus
		});
};
var _cmditch$mel_bew3$Web3_Eth$protocolVersion = function (ethNode) {
	return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
		{
			url: ethNode,
...
var _cmditch$mel_bew3$Web3_Eth$sign = F3(
		...
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				...
				params: {
					ctor: '::',
					_0: _cmditch$mel_bew3$Web3_Eth_Encode$address(address),
					_1: {
						ctor: '::',
...
var _cmditch$mel_bew3$Web3_Eth$uninstallFilter = F2(
...
var _cmditch$mel_bew3$Web3_Eth$getFilterLogs = F3(
...
var _cmditch$mel_bew3$Web3_Eth$getFilterChanges = F3(
	function (ethNode, decoder, filterId) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
...
var _cmditch$mel_bew3$Web3_Eth$newPendingTxFilter = function (ethNode) {
	return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
		{
			url: ethNode,
			method: 'eth_newPendingTransactionFilter',
...
var _cmditch$mel_bew3$Web3_Eth$newBlockFilter = function (ethNode) {
	return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
		{
			url: ethNode,
...
var _cmditch$mel_bew3$Web3_Eth$newFilter = F2(
		...
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				...
				params: {
					ctor: '::',
					_0: _cmditch$mel_bew3$Web3_Eth_Encode$logFilter(logFilter),
					_1: {ctor: '[]'}
				},
				decoder: _elm_lang$core$Json_Decode$string
			});
	});
var _cmditch$mel_bew3$Web3_Eth$getLogs = F2(
	function (ethNode, logFilter) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
				...
				decoder: _elm_lang$core$Json_Decode$list(_cmditch$mel_bew3$Web3_Eth_Decode$log)
			});
	});
var _cmditch$mel_bew3$Web3_Eth$getUncleByBlockHashAtIndex = F3(
		...
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				...
				params: {
					ctor: '::',
					_0: _cmditch$mel_bew3$Web3_Eth_Encode$blockHash(blockHash),
					_1: {
						ctor: '::',
						_0: _cmditch$mel_bew3$Web3_Encode$hexInt(uncleIndex),
						_1: {ctor: '[]'}
					}
				},
				decoder: _cmditch$mel_bew3$Web3_Eth_Decode$uncle
			});
	});
var _cmditch$mel_bew3$Web3_Eth$getUncleAtIndex = F3(
		...
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				...
				params: {
					ctor: '::',
					_0: _cmditch$mel_bew3$Web3_Encode$hexInt(blockNumber),
					_1: {
						ctor: '::',
						_0: _cmditch$mel_bew3$Web3_Encode$hexInt(uncleIndex),
						_1: {ctor: '[]'}
...
var _cmditch$mel_bew3$Web3_Eth$getUncleCountByHash = F2(
...
var _cmditch$mel_bew3$Web3_Eth$getUncleCount = F2(
...
var _cmditch$mel_bew3$Web3_Eth$getBlockTxCountByHash = F2(
	function (ethNode, blockHash) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
...
var _cmditch$mel_bew3$Web3_Eth$getBlockTxCount = F2(
	function (ethNode, blockNumber) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
...
var _cmditch$mel_bew3$Web3_Eth$getBlockByHashWithTxObjs = F2(
	function (ethNode, blockHash) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
				...
				decoder: _cmditch$mel_bew3$Web3_Eth_Decode$block(_cmditch$mel_bew3$Web3_Eth_Decode$tx)
			});
	});
var _cmditch$mel_bew3$Web3_Eth$getBlockWithTxObjs = F2(
		...
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				...
				params: {
					ctor: '::',
					_0: _cmditch$mel_bew3$Web3_Encode$hexInt(blockNum),
					_1: {
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$bool(true),
						_1: {ctor: '[]'}
...
var _cmditch$mel_bew3$Web3_Eth$getBlockByHash = F2(
	function (ethNode, blockHash) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
				...
				decoder: _cmditch$mel_bew3$Web3_Eth_Decode$block(_cmditch$mel_bew3$Web3_Eth_Decode$txHash)
			});
	});
var _cmditch$mel_bew3$Web3_Eth$getBlock = F2(
	function (ethNode, blockNum) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
...
var _cmditch$mel_bew3$Web3_Eth$getBlockNumber = function (ethNode) {
	return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
		{
			url: ethNode,
...
var _cmditch$mel_bew3$Web3_Eth$getTxCountAtBlock = F3(
	function (ethNode, blockId, address) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
				...
				params: {
					...
					_1: {
						ctor: '::',
						_0: _cmditch$mel_bew3$Web3_Eth_Encode$blockId(blockId),
						_1: {ctor: '[]'}
					}
				},
				decoder: _cmditch$mel_bew3$Web3_Decode$hexInt
...
var _cmditch$mel_bew3$Web3_Eth$getTxCount = F2(
	function (ethNode, address) {
		return A3(_cmditch$mel_bew3$Web3_Eth$getTxCountAtBlock, ethNode, _cmditch$mel_bew3$Web3_Eth_Types$LatestBlock, address);
	});
var _cmditch$mel_bew3$Web3_Eth$getBalanceAtBlock = F3(
	function (ethNode, blockId, address) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
...
var _cmditch$mel_bew3$Web3_Eth$getBalance = F2(
	function (ethNode, address) {
		return A3(_cmditch$mel_bew3$Web3_Eth$getBalanceAtBlock, ethNode, _cmditch$mel_bew3$Web3_Eth_Types$LatestBlock, address);
	});
var _cmditch$mel_bew3$Web3_Eth$sendRawTx = F2(
		...
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				...
				decoder: _cmditch$mel_bew3$Web3_Eth_Decode$txHash
			});
	});
var _cmditch$mel_bew3$Web3_Eth$sendTx = F2(
		...
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				...
				params: {
					ctor: '::',
					_0: _cmditch$mel_bew3$Web3_Eth_Encode$sendParams(txParams),
					_1: {ctor: '[]'}
				},
				decoder: _cmditch$mel_bew3$Web3_Eth_Decode$txHash
			});
	});
var _cmditch$mel_bew3$Web3_Eth$send = function (_p0) {
	var _p1 = _p0;
	return {to: _p1.to, from: _p1.from, gas: _p1.gas, gasPrice: _p1.gasPrice, value: _p1.value, data: _p1.data, nonce: _p1.nonce};
};
var _cmditch$mel_bew3$Web3_Eth$getTxByBlockNumberAndIndex = F3(
		...
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				...
				params: {
					...
					_1: {
						ctor: '::',
						_0: _cmditch$mel_bew3$Web3_Encode$hexInt(txIndex),
						_1: {ctor: '[]'}
					}
				},
				decoder: _cmditch$mel_bew3$Web3_Eth_Decode$tx
			});
	});
var _cmditch$mel_bew3$Web3_Eth$getTxByBlockHashAndIndex = F3(
...
var _cmditch$mel_bew3$Web3_Eth$getTxReceipt = F2(
		...
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				...
				params: {
					ctor: '::',
					_0: _cmditch$mel_bew3$Web3_Eth_Encode$txHash(txHash),
					_1: {ctor: '[]'}
				},
				decoder: _cmditch$mel_bew3$Web3_Eth_Decode$txReceipt
			});
	});
var _cmditch$mel_bew3$Web3_Eth$getTx = F2(
	function (ethNode, txHash) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
...
var _cmditch$mel_bew3$Web3_Eth$getCodeAtBlock = F3(
	function (ethNode, blockId, address) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
...
var _cmditch$mel_bew3$Web3_Eth$getCode = F2(
	function (ethNode, address) {
		return A3(_cmditch$mel_bew3$Web3_Eth$getCodeAtBlock, ethNode, _cmditch$mel_bew3$Web3_Eth_Types$LatestBlock, address);
	});
var _cmditch$mel_bew3$Web3_Eth$getStorageAtBlock = F4(
	function (ethNode, blockId, address, index) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
				...
				params: {
					...
					_1: {
						ctor: '::',
						_0: _cmditch$mel_bew3$Web3_Encode$hexInt(index),
						_1: {
							ctor: '::',
							_0: _cmditch$mel_bew3$Web3_Eth_Encode$blockId(blockId),
							_1: {ctor: '[]'}
...
var _cmditch$mel_bew3$Web3_Eth$getStorageAt = F3(
	function (ethNode, address, index) {
		return A4(_cmditch$mel_bew3$Web3_Eth$getStorageAtBlock, ethNode, _cmditch$mel_bew3$Web3_Eth_Types$LatestBlock, address, index);
	});
var _cmditch$mel_bew3$Web3_Eth$estimateGas = F2(
	function (ethNode, txParams) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
				...
				params: {
					ctor: '::',
					_0: _cmditch$mel_bew3$Web3_Eth_Encode$callParams(txParams),
					_1: {ctor: '[]'}
				},
				decoder: _cmditch$mel_bew3$Web3_Decode$hexInt
			});
	});
var _cmditch$mel_bew3$Web3_Eth$callAtBlock = F3(
	function (ethNode, blockId, txParams) {
		return _cmditch$mel_bew3$Web3_JsonRPC$buildRequest(
			{
				url: ethNode,
				method: 'eth_call',
...
var _cmditch$mel_bew3$Web3_Eth$call = F2(
	function (ethNode, txParams) {
		return A3(_cmditch$mel_bew3$Web3_Eth$callAtBlock, ethNode, _cmditch$mel_bew3$Web3_Eth_Types$LatestBlock, txParams);
	});

var _cmditch$mel_bew3$Web3_Eth_TxSentry$log = {
	signed: F2(
		function (txHash, ref) {
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(txHash),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' (dict-ref: ',
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(ref),
							')'))));
		}),
	broadcast: F2(
		function (tx, ref) {
	...
	broadcastError: function (error) {
		return A2(
			_elm_lang$core$Debug$log,
			'TxSentry - Error Broadcasting',
			_elm_lang$core$Basics$toString(error));
	},
	mined: F2(
		function (txReceipt, ref) {
			return A2(
				_elm_lang$core$Debug$log,
				'TxSentry - Tx Mined',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(txReceipt),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' (dict-ref: ',
						A2(
	...
	minedError: function (error) {
		return A2(
			_elm_lang$core$Debug$log,
			'TxSentry - Error Mining',
			_elm_lang$core$Basics$toString(error));
	},
	nodeChanged: function (newNodePath) {
		return A2(
			_elm_lang$core$Debug$log,
			'TxSentry - Nodepath changed',
			_elm_lang$core$Basics$toString(newNodePath));
	},
	decodeError: function (error) {
		return A2(
			_elm_lang$core$Debug$log,
			'Error decoding',
			A2(_elm_lang$core$Basics_ops['++'], error, ' (Problem is likely in your JS port code. Make sure you\'re sending me a value that looks like this { ref: Int, txHash: TxHash }'));
	}
};
var _cmditch$mel_bew3$Web3_Eth_TxSentry$debugHelp = F2(
	function (sentry, logger) {
		return sentry.debug ? logger : '';
	});
var _cmditch$mel_bew3$Web3_Eth_TxSentry$txIdResponseDecoder = A3(
	...
	A2(_elm_lang$core$Json_Decode$field, 'txHash', _cmditch$mel_bew3$Web3_Eth_Decode$txHash));
var _cmditch$mel_bew3$Web3_Eth_TxSentry$encodeTxData = F2(
	function (ref, send) {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'txParams',
						_1: _cmditch$mel_bew3$Web3_Eth_Encode$sendParams(send)
					},
					_1: {ctor: '[]'}
				}
			});
	});
var _cmditch$mel_bew3$Web3_Eth_TxSentry$pollTxBroadcast = F2(
		...
		return A2(
			...
			function (_p0) {
				return A2(
					_cmditch$mel_bew3$Web3_Utils$retry,
					{attempts: 30, sleep: 1},
					A2(_cmditch$mel_bew3$Web3_Eth$getTx, nodePath, txHash));
			},
			_elm_lang$core$Process$sleep(250));
	});
var _cmditch$mel_bew3$Web3_Eth_TxSentry$pollTxReceipt = F2(
	function (nodePath, txHash) {
		return A2(
			_cmditch$mel_bew3$Web3_Utils$retry,
			{attempts: 60, sleep: 5},
			A2(_cmditch$mel_bew3$Web3_Eth$getTxReceipt, nodePath, txHash));
	});
var _cmditch$mel_bew3$Web3_Eth_TxSentry$CustomSend = F3(
	function (a, b, c) {
		return {onSign: a, onBroadcast: b, onMined: c};
	});
var _cmditch$mel_bew3$Web3_Eth_TxSentry$TxState = F5(
	function (a, b, c, d, e) {
		return {params: a, onSignedTagger: b, onBroadcastTagger: c, onMinedTagger: d, status: e};
	});
var _cmditch$mel_bew3$Web3_Eth_TxSentry$TxSentry = function (a) {
	return {ctor: 'TxSentry', _0: a};
};
var _cmditch$mel_bew3$Web3_Eth_TxSentry$init = F3(
	function (_p1, tagger, nodePath) {
		var _p2 = _p1;
		return _cmditch$mel_bew3$Web3_Eth_TxSentry$TxSentry(
			{inPort: _p2._0, outPort: _p2._1, nodePath: nodePath, tagger: tagger, txs: _elm_lang$core$Dict$empty, debug: false, ref: 1});
	});
var _cmditch$mel_bew3$Web3_Eth_TxSentry$withDebug = function (_p3) {
	var _p4 = _p3;
	return _cmditch$mel_bew3$Web3_Eth_TxSentry$TxSentry(
		_elm_lang$core$Native_Utils.update(
			_p4._0,
...
var _cmditch$mel_bew3$Web3_Eth_TxSentry$changeNode = F2(
	function (newNodePath, _p5) {
		var _p6 = _p5;
		var _p8 = _p6._0;
		var _p7 = A2(
			_cmditch$mel_bew3$Web3_Eth_TxSentry$debugHelp,
			_p8,
			_cmditch$mel_bew3$Web3_Eth_TxSentry$log.nodeChanged(newNodePath));
		return _cmditch$mel_bew3$Web3_Eth_TxSentry$TxSentry(
			_elm_lang$core$Native_Utils.update(
				_p8,
				{nodePath: newNodePath}));
	});
var _cmditch$mel_bew3$Web3_Eth_TxSentry$Mined = function (a) {
	return {ctor: 'Mined', _0: a};
};
var _cmditch$mel_bew3$Web3_Eth_TxSentry$txStatusMined = function (txReceipt) {
	return _elm_lang$core$Maybe$map(
		function (txState) {
			return _elm_lang$core$Native_Utils.update(
				txState,
				{
					status: _cmditch$mel_bew3$Web3_Eth_TxSentry$Mined(txReceipt)
				});
		});
};
var _cmditch$mel_bew3$Web3_Eth_TxSentry$Sent = function (a) {
	return {ctor: 'Sent', _0: a};
};
var _cmditch$mel_bew3$Web3_Eth_TxSentry$txStatusSent = function (tx) {
	return _elm_lang$core$Maybe$map(
		function (txState) {
			return _elm_lang$core$Native_Utils.update(
				txState,
				{
					status: _cmditch$mel_bew3$Web3_Eth_TxSentry$Sent(tx)
				});
		});
};
var _cmditch$mel_bew3$Web3_Eth_TxSentry$Signed = function (a) {
	return {ctor: 'Signed', _0: a};
};
var _cmditch$mel_bew3$Web3_Eth_TxSentry$txStatusSigned = function (txHash) {
	return _elm_lang$core$Maybe$map(
		function (txState) {
			return _elm_lang$core$Native_Utils.update(
				txState,
				{
					status: _cmditch$mel_bew3$Web3_Eth_TxSentry$Signed(txHash)
				});
		});
};
var _cmditch$mel_bew3$Web3_Eth_TxSentry$Signing = function (a) {
	return {ctor: 'Signing', _0: a};
};
var _cmditch$mel_bew3$Web3_Eth_TxSentry$newTxState = F2(
	function (send, _p9) {
		var _p10 = _p9;
		return {
			params: send,
			onSignedTagger: _p10.onSign,
			onBroadcastTagger: _p10.onBroadcast,
			onMinedTagger: _p10.onMined,
			status: _cmditch$mel_bew3$Web3_Eth_TxSentry$Signing(send)
		};
	});
var _cmditch$mel_bew3$Web3_Eth_TxSentry$send_ = F3(
	function (sendParams, txParams, _p11) {
		var _p12 = _p11;
		var _p13 = _p12._0;
		var newTxs = A3(
			_elm_lang$core$Dict$insert,
			_p13.ref,
			A2(_cmditch$mel_bew3$Web3_Eth_TxSentry$newTxState, txParams, sendParams),
			_p13.txs);
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_cmditch$mel_bew3$Web3_Eth_TxSentry$TxSentry(
				_elm_lang$core$Native_Utils.update(
					_p13,
					{txs: newTxs, ref: _p13.ref + 1})),
			{
				ctor: '::',
				_0: A2(
					...
					_p13.tagger,
					_p13.outPort(
						A2(_cmditch$mel_bew3$Web3_Eth_TxSentry$encodeTxData, _p13.ref, txParams))),
				_1: {ctor: '[]'}
			});
	});
var _cmditch$mel_bew3$Web3_Eth_TxSentry$send = F3(
	function (onBroadcast, txParams, sentry) {
		return A3(
			_cmditch$mel_bew3$Web3_Eth_TxSentry$send_,
			{
...
var _cmditch$mel_bew3$Web3_Eth_TxSentry$sendWithReceipt = F4(
	function (onBroadcast, onMined, txParams, sentry) {
		return A3(
			_cmditch$mel_bew3$Web3_Eth_TxSentry$send_,
			{
				onSign: _elm_lang$core$Maybe$Nothing,
				onBroadcast: _elm_lang$core$Maybe$Just(onBroadcast),
				onMined: _elm_lang$core$Maybe$Just(onMined)
			},
			txParams,
			sentry);
	});
var _cmditch$mel_bew3$Web3_Eth_TxSentry$customSend = _cmditch$mel_bew3$Web3_Eth_TxSentry$send_;
var _cmditch$mel_bew3$Web3_Eth_TxSentry$TxMined = F2(
	function (a, b) {
		return {ctor: 'TxMined', _0: a, _1: b};
	});
var _cmditch$mel_bew3$Web3_Eth_TxSentry$TxSent = F2(
	function (a, b) {
		return {ctor: 'TxSent', _0: a, _1: b};
	});
var _cmditch$mel_bew3$Web3_Eth_TxSentry$update = F2(
	function (msg, _p14) {
		var _p15 = _p14;
		var _p39 = _p15._0;
		var _p16 = msg;
		switch (_p16.ctor) {
			case 'NoOp':
				return {
					ctor: '_Tuple2',
					_0: _cmditch$mel_bew3$Web3_Eth_TxSentry$TxSentry(_p39),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'TxSigned':
				var _p21 = _p16._0.txHash;
				var _p20 = _p16._0.ref;
				var _p17 = A2(_elm_lang$core$Dict$get, _p20, _p39.txs);
				if (_p17.ctor === 'Just') {
					var txBroadcastCmd = A2(
						_elm_lang$core$Platform_Cmd$map,
						_p39.tagger,
						A2(
							_elm_lang$core$Task$attempt,
							_cmditch$mel_bew3$Web3_Eth_TxSentry$TxSent(_p20),
							A2(_cmditch$mel_bew3$Web3_Eth_TxSentry$pollTxBroadcast, _p39.nodePath, _p21)));
					var txSignedCmd = function () {
						var _p18 = _p17._0.onSignedTagger;
						if (_p18.ctor === 'Just') {
							return A2(
								_elm_lang$core$Task$perform,
								_p18._0,
								_elm_lang$core$Task$succeed(_p21));
						} else {
					...
					var _p19 = A2(
						_cmditch$mel_bew3$Web3_Eth_TxSentry$debugHelp,
						_p39,
						A2(_cmditch$mel_bew3$Web3_Eth_TxSentry$log.signed, _p21, _p20));
					return {
						ctor: '_Tuple2',
						_0: _cmditch$mel_bew3$Web3_Eth_TxSentry$TxSentry(
							_elm_lang$core$Native_Utils.update(
								_p39,
								{
									txs: A3(
										_elm_lang$core$Dict$update,
										_p20,
										_cmditch$mel_bew3$Web3_Eth_TxSentry$txStatusSigned(_p21),
										_p39.txs)
								})),
			...
			case 'TxSent':
				...
				if (_p22.ctor === 'Ok') {
					...
					var _p23 = A2(
						_cmditch$mel_bew3$Web3_Eth_TxSentry$debugHelp,
						_p39,
						A2(_cmditch$mel_bew3$Web3_Eth_TxSentry$log.broadcast, _p28, _p30));
					var _p24 = A2(_elm_lang$core$Dict$get, _p30, _p39.txs);
					if (_p24.ctor === 'Just') {
						var _p27 = _p24._0;
						var txMinedCmd = function () {
							var _p25 = _p27.onMinedTagger;
							if (_p25.ctor === 'Just') {
								return A2(
									_elm_lang$core$Platform_Cmd$map,
									_p39.tagger,
									A2(
										_elm_lang$core$Task$attempt,
										_cmditch$mel_bew3$Web3_Eth_TxSentry$TxMined(_p30),
										A2(_cmditch$mel_bew3$Web3_Eth_TxSentry$pollTxReceipt, _p39.nodePath, _p28.hash)));
							} else {
								return _elm_lang$core$Platform_Cmd$none;
							}
						}();
						var txBroadcastCmd = function () {
							var _p26 = _p27.onBroadcastTagger;
							if (_p26.ctor === 'Just') {
								return A2(
									_elm_lang$core$Task$perform,
									_p26._0,
									_elm_lang$core$Task$succeed(_p28));
							} else {
								return _elm_lang$core$Platform_Cmd$none;
							}
						}();
								...
								_elm_lang$core$Native_Utils.update(
									_p39,
									{
										txs: A3(
											_elm_lang$core$Dict$update,
											_p30,
											_cmditch$mel_bew3$Web3_Eth_TxSentry$txStatusSent(_p28),
											_p39.txs)
									})),
							_1: _elm_lang$core$Platform_Cmd$batch(
								{
					...
					var _p29 = A2(
						_cmditch$mel_bew3$Web3_Eth_TxSentry$debugHelp,
						_p39,
						_cmditch$mel_bew3$Web3_Eth_TxSentry$log.broadcastError(_p22._0));
					return {
						ctor: '_Tuple2',
						_0: _cmditch$mel_bew3$Web3_Eth_TxSentry$TxSentry(_p39),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'TxMined':
				...
				if (_p31.ctor === 'Ok') {
					...
					var _p32 = A2(
						_cmditch$mel_bew3$Web3_Eth_TxSentry$debugHelp,
						_p39,
						A2(_cmditch$mel_bew3$Web3_Eth_TxSentry$log.mined, _p35, _p37));
					var _p33 = A2(_elm_lang$core$Dict$get, _p37, _p39.txs);
					if (_p33.ctor === 'Just') {
						var cmdIfMined = function () {
							var _p34 = _p33._0.onMinedTagger;
							if (_p34.ctor === 'Just') {
								return A2(
									_elm_lang$core$Task$perform,
									_p34._0,
									_elm_lang$core$Task$succeed(_p35));
							} else {
								return _elm_lang$core$Platform_Cmd$none;
							}
						}();
								...
								_elm_lang$core$Native_Utils.update(
									_p39,
									{
										txs: A3(
											_elm_lang$core$Dict$update,
											_p37,
											_cmditch$mel_bew3$Web3_Eth_TxSentry$txStatusMined(_p35),
											_p39.txs)
									})),
							_1: cmdIfMined
						};
					...
					var _p36 = A2(
						_cmditch$mel_bew3$Web3_Eth_TxSentry$debugHelp,
						_p39,
						_cmditch$mel_bew3$Web3_Eth_TxSentry$log.minedError(_p31._0));
					return {
						ctor: '_Tuple2',
						_0: _cmditch$mel_bew3$Web3_Eth_TxSentry$TxSentry(_p39),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			default:
				var _p38 = A2(
					_cmditch$mel_bew3$Web3_Eth_TxSentry$debugHelp,
					_p39,
					_cmditch$mel_bew3$Web3_Eth_TxSentry$log.decodeError(_p16._0));
				return {
					ctor: '_Tuple2',
					_0: _cmditch$mel_bew3$Web3_Eth_TxSentry$TxSentry(_p39),
					_1: _elm_lang$core$Platform_Cmd$none
...
var _cmditch$mel_bew3$Web3_Eth_TxSentry$TxSigned = function (a) {
	return {ctor: 'TxSigned', _0: a};
};
var _cmditch$mel_bew3$Web3_Eth_TxSentry$ErrorDecoding = function (a) {
	return {ctor: 'ErrorDecoding', _0: a};
};
var _cmditch$mel_bew3$Web3_Eth_TxSentry$decodeTxData = function (val) {
	var _p40 = A2(_elm_lang$core$Json_Decode$decodeValue, _cmditch$mel_bew3$Web3_Eth_TxSentry$txIdResponseDecoder, val);
	if (_p40.ctor === 'Ok') {
		return _cmditch$mel_bew3$Web3_Eth_TxSentry$TxSigned(_p40._0);
	} else {
		return _cmditch$mel_bew3$Web3_Eth_TxSentry$ErrorDecoding(_p40._0);
	}
};
var _cmditch$mel_bew3$Web3_Eth_TxSentry$listen = function (_p41) {
	var _p42 = _p41;
	var _p43 = _p42._0;
	return A2(
		_elm_lang$core$Platform_Sub$map,
		_p43.tagger,
		_p43.inPort(_cmditch$mel_bew3$Web3_Eth_TxSentry$decodeTxData));
};
var _cmditch$mel_bew3$Web3_Eth_TxSentry$NoOp = {ctor: 'NoOp'};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'TxSentryMsg':
				var _p1 = A2(_cmditch$mel_bew3$Web3_Eth_TxSentry$update, _p0._0, model.txSentry);
				var subModel = _p1._0;
				var subCmd = _p1._1;
				return {
					ctor: '_Tuple2',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: _elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(model.account)),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {txSentry: a, account: b, errors: c};
	});
...
var _user$project$Main$accountListenerToMsg = function (val) {
	return _user$project$Main$SetAccount(
		_elm_lang$core$Result$toMaybe(
			A2(_elm_lang$core$Json_Decode$decodeValue, _cmditch$mel_bew3$Web3_Eth_Decode$address, val)));
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				ctor: '::',
				_0: _cmditch$mel_bew3$Web3_Eth_TxSentry$listen(model.txSentry),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$init = A2(
	...
	{
		txSentry: A3(
			_cmditch$mel_bew3$Web3_Eth_TxSentry$init,
			{ctor: '_Tuple2', _0: _user$project$Main$txIn, _1: _user$project$Main$txOut},
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Web3.Internal.Types.BlockHash":{"args":[],"tags":{"BlockHash":["String"]}},"BigInt.Magnitude":{"args":[],"tags":{"Magnitude":["List Int"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Web3.Eth.TxSentry.Msg":{"args":[],"tags":{"TxMined":["Int","Result.Result Http.Error Web3.Eth.Types.TxReceipt"],"ErrorDecoding":["String"],"TxSent":["Int","Result.Result Http.Error Web3.Eth.Types.Tx"],"NoOp":[],"TxSigned":["{ ref : Int, txHash : Web3.Eth.Types.TxHash }"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"TxSentryMsg":["Web3.Eth.TxSentry.Msg"],"SetAccount":["Maybe.Maybe Web3.Eth.Types.Address"],"NoOp":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Web3.Internal.Types.TxHash":{"args":[],"tags":{"TxHash":["String"]}},"Web3.Internal.Types.Address":{"args":[],"tags":{"Address":["String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"BigInt.BigInt":{"args":[],"tags":{"Pos":["BigInt.Magnitude"],"Neg":["BigInt.Magnitude"],"Zer":[]}}},"aliases":{"Web3.Eth.Types.BlockHash":{"args":[],"type":"Web3.Internal.Types.BlockHash"},"Web3.Eth.Types.TxReceipt":{"args":[],"type":"{ hash : Web3.Eth.Types.TxHash , index : Int , blockHash : Web3.Eth.Types.BlockHash , blockNumber : Int , gasUsed : BigInt.BigInt , cumulativeGasUsed : BigInt.BigInt , contractAddress : Maybe.Maybe Web3.Eth.Types.Address , logs : List Web3.Eth.Types.Log , logsBloom : String , root : Maybe.Maybe String , status : Maybe.Maybe Bool }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Web3.Eth.Types.Log":{"args":[],"type":"{ address : Web3.Eth.Types.Address , data : String , topics : List String , removed : Bool , logIndex : Int , transactionIndex : Int , transactionHash : Web3.Eth.Types.TxHash , blockHash : Web3.Eth.Types.BlockHash , blockNumber : Int }"},"Web3.Eth.Types.Tx":{"args":[],"type":"{ hash : Web3.Eth.Types.TxHash , nonce : Int , blockHash : Maybe.Maybe Web3.Eth.Types.BlockHash , blockNumber : Maybe.Maybe Int , transactionIndex : Int , from : Web3.Eth.Types.Address , to : Maybe.Maybe Web3.Eth.Types.Address , value : BigInt.BigInt , gasPrice : BigInt.BigInt , gas : Int , input : String }"},"Web3.Eth.Types.TxHash":{"args":[],"type":"Web3.Internal.Types.TxHash"},"Web3.Eth.Types.Address":{"args":[],"type":"Web3.Internal.Types.Address"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
